  ...
  <!-- ============================================================== -->
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor">Edit Property</h3>
			<ol class="breadcrumb">
			...
			<div class="card">
				<div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg" id="address_1" name="address_1" value="{{$property->address_1}}">
                        </div>

                        <div class="form-group">
                            <label for="address_2">Address 2</label>
                            <input type="text" class="form-control form-control-lg" id="address_2" name="address_2" value="{{$property->address_2}}">
                        </div>

                        <div class="form-group">
                            <label for="city">City</label>
                            <input type="text" class="form-control form-control-lg" id="city" name="city" value="{{$property->city}}">
                        </div>

                        <!-- TODO: find a list of states to loop -->
                        <div class="form-group">
                            <label for="state">State</label>
                            <input type="text" class="form-control form-control-lg" id="state" name="state" value="{{$property->state}}">
                        </div>

                        <div class="form-group">
                            <label for="zip">Zip Code</label>
                            <input type="text" class="form-control form-control-lg" id="zip" name="zip" value="{{$property->zip}}">
                        </div>

                        <!-- TODO: find a list of countries to loop -->
                        <div class="form-group">
                            <label for="country">Country</label>
                            <input type="text" class="form-control form-control-lg" id="country" name="country" value="{{$property->country}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="lease_length" class="form-control form-control-lg">
                                <option {{ $property->lease_length == '0' ? 'selected':'' }}>Month To Month</option>
                                <option {{ $property->lease_length == '3' ? 'selected':'' }}>3</option>
                                <option {{ $property->lease_length == '6' ? 'selected':'' }}>6</option>
                                <option {{ $property->lease_length == '8' ? 'selected':'' }}>8</option>
                                <option {{ $property->lease_length == '10' ? 'selected':'' }}>10</option>
                                <option {{ $property->lease_length == '12' ? 'selected':'' }}>12</option>
                                <option {{ $property->lease_length == '18' ? 'selected':'' }}>18</option>
                                <option {{ $property->lease_length == '24' ? 'selected':'' }}">24</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="rent_amount">Rent Amount</label>
                            <input type="text" class="form-control form-control-lg" id="rent_amount" name="rent_amount" value="{{$property->rent_amount}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="occupied" id="pet_no" value="{{$property->pet}}" checked>
                                <label class="form-check-label" for="pet_yes">Yes</label>
                            </div>
                        </div>
